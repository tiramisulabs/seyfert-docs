...
In Seyfert, we can play music using a external library called [kazagumo](https://npmjs.com/package/kazagumo).
...
To be able to move forward within this guide it is highly recommended to read the [Understanding declare module](guide/declare-module) for a better understanding of what we are doing.
:::

...
First, `kazagumo` will obviously be installed, and this other dependency `shoukaku`.
...
In this part, we are going to assume that you read the [Understanding declare module](guide/declare-module) section 
:::

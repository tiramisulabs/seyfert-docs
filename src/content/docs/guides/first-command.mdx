...
To test if your command works correctly, you can first publish it on Discord after making minor changes to your main file:
...
```ts {4-5,9-13,19,22-24} title="src/commands/ping.ts" showLineNumbers
import {
  Command,
  Declare,
  Options,

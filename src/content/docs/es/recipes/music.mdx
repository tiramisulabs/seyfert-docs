...
Para poder avanzar dentro de esta guía es muy recomendable leer [Entendiendo el `declare module`](/getting-started/declare-module) para una mejor comprensión de lo que estamos haciendo.
:::

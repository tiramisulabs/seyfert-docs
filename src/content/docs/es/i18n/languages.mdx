...
Antes de empezar este capítulo debe actualizar `seyfert.config.js` para decirle a seyfert donde estará nuestro fichero de idiomas.
...
} satisfies English; // Este es un type de utilidad para asegurar que el objeto es el mismo en todos los idiomas
```

...
:::note
Actualmente, no hay soporte para aplicaciones que usen tanto `comandos de prefijo` como `comandos de aplicación` para seleccionar qué comandos son de un tipo específico. Todos los comandos se consideran como comandos de aplicación y comandos de prefijo.
:::

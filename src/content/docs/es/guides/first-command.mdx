...
:::caution
Si obtiene algún error de tipo en el código, consulte [Entendiendo el `declare module`](/guides/declare-module)
:::
...
```ts {4-5,10-14,20,24} title="src/commands/ping.ts" showLineNumbers
import {
  Command,
  Declare,
  Options,

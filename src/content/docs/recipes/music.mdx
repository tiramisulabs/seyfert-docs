...
To be able to move forward within this guide it is highly recommended to read the [Understanding declare module](/getting-started/declare-module) for a better understanding of what we are doing.
:::

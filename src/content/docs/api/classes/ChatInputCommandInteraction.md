...
| `data.options` | `public` | `undefined` \| `APIApplicationCommandInteractionDataOption`[] | - | - |
...
| `type` | `public` | `ApplicationCommandType` | [`ApplicationCommandInteraction`](/api/classes/applicationcommandinteraction/).`type` | [`ApplicationCommandInteraction`](/api/classes/applicationcommandinteraction/).`type` |

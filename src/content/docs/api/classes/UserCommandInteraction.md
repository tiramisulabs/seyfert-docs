...
| `data.resolved.members` | `public` | `undefined` \| `Record`\<`string`, `APIInteractionDataResolvedGuildMember`\> | - | - |
...
| `type` | `public` | `User` | [`ApplicationCommandInteraction`](/api/classes/applicationcommandinteraction/).`type` | [`ApplicationCommandInteraction`](/api/classes/applicationcommandinteraction/).`type` |
...
[seyfert/src/structures/Interaction.ts:424](https://github.com/potoland/potocuit/blob/e332d7a/src/structures/Interaction.ts#L424)

[seyfert](../globals.md) / MessageCommandInteraction

# Class: MessageCommandInteraction\<FromGuild\>

## Extends

- [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md)\<`FromGuild`, `APIMessageApplicationCommandInteraction`\>
...
[`MessageCommandInteraction`](MessageCommandInteraction.md)\<`FromGuild`\>
...
| `data` | `public` | \{ `guildId`: `undefined` \| `string`; `id`: `string`; `name`: `string`; `resolved`: \{ `messages`: \{\}; \}; `targetId`: `string`; `type`: `Message`; \} | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`data` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`data` |
| `data.guildId` | `public` | `undefined` \| `string` | - | - |
| `data.id` | `public` | `string` | - | - |
| `data.name` | `public` | `string` | - | - |
| `data.resolved` | `public` | \{ `messages`: \{\}; \} | - | - |
| `data.resolved.messages` | `public` | \{\} | - | - |
...
| `type` | `public` | `Message` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`type` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`type` |

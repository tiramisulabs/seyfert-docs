[seyfert](../globals.md) / ForumChannel

# Class: ForumChannel

## Extends

- `ObjectToLower`\<`APIGuildForumChannel`\>.`Omit`\<[`ThreadOnlyMethods`](ThreadOnlyMethods.md), `"type"`\>.[`WebhookChannelMethods`](WebhookChannelMethods.md).[`BaseChannel`](BaseChannel.md)\<`ChannelType.GuildForum`\>
...
```ts
new ForumChannel(client: UsingClient, data: APIChannelBase<ChannelType>): ForumChannel
```
...
| :------ | :------ | :------ | :------ | :------ |
| `availableTags` | `public` | \{ `emojiId`: `null` \| `string`; `emojiName`: `null` \| `string`; `id`: `string`; `moderated`: `boolean`; `name`: `string`; \}[] | `undefined` | `ObjectToLower.availableTags` |
...
| `defaultForumLayout` | `public` | `ForumLayoutType` | `undefined` | `ObjectToLower.defaultForumLayout` |
| `defaultReactionEmoji` | `public` | `null` \| \{ `emojiId`: `null` \| `string`; `emojiName`: `null` \| `string`; \} | `undefined` | `ObjectToLower.defaultReactionEmoji` |
| `defaultSortOrder` | `public` | `null` \| `SortOrderType` | `undefined` | `ObjectToLower.defaultSortOrder` |
...
| `permissionOverwrites` | `public` | `undefined` \| \{ `allow`: `string`; `deny`: `string`; `id`: `string`; `type`: `OverwriteType`; \}[] | `undefined` | `ObjectToLower.permissionOverwrites` |
...
| `type` | `public` | `GuildForum` | `undefined` | [`BaseChannel`](BaseChannel.md).`type` |

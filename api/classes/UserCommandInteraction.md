[seyfert](../globals.md) / UserCommandInteraction

# Class: UserCommandInteraction\<FromGuild\>

## Extends

- [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md)\<`FromGuild`, `APIUserApplicationCommandInteraction`\>
...
[`UserCommandInteraction`](UserCommandInteraction.md)\<`FromGuild`\>
...
| :------ | :------ | :------ | :------ | :------ |
| `__reply?` | `protected` | `__InternalReplyFunction` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`__reply` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`__reply` |
| `appPermissions?` | `public` | `PermissionsBitField` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`appPermissions` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`appPermissions` |
| `applicationId` | `public` | `string` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`applicationId` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`applicationId` |
| `authorizingIntegrationOwners` | `public` | \{\} | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`authorizingIntegrationOwners` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`authorizingIntegrationOwners` |
| `channel?` | `public` | [`AllChannels`](../type-aliases/AllChannels.md) | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`channel` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`channel` |
| `channelId` | `public` | `undefined` \| `string` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`channelId` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`channelId` |
| `client` | `readonly` | [`UsingClient`](../interfaces/UsingClient.md) | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`client` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`client` |
| `context` | `public` | `undefined` \| `InteractionContextType` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`context` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`context` |
| `data` | `public` | \{ `guildId`: `undefined` \| `string`; `id`: `string`; `name`: `string`; `resolved`: \{ `members`: `undefined` \| \{\}; `users`: \{\}; \}; `targetId`: `string`; `type`: `User`; \} | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`data` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`data` |
| `data.guildId` | `public` | `undefined` \| `string` | - | - |
| `data.id` | `public` | `string` | - | - |
| `data.name` | `public` | `string` | - | - |
| `data.resolved` | `public` | \{ `members`: `undefined` \| \{\}; `users`: \{\}; \} | - | - |
| `data.resolved.members` | `public` | `undefined` \| \{\} | - | - |
| `data.resolved.users` | `public` | \{\} | - | - |
| `data.targetId` | `public` | `string` | - | - |
| `data.type` | `public` | `User` | - | - |
| `entitlements` | `public` | \{ `applicationId`: `string`; `consumed`: `undefined` \| `boolean`; `deleted`: `boolean`; `endsAt`: `undefined` \| `string`; `guildId`: `undefined` \| `string`; `id`: `string`; `skuId`: `string`; `startsAt`: `undefined` \| `string`; `type`: `EntitlementType`; `userId`: `undefined` \| `string`; \}[] | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`entitlements` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`entitlements` |
| `guildId` | `public` | `undefined` \| `string` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`guildId` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`guildId` |
| `guildLocale` | `public` |  \| `undefined` \| `"id"` \| `"en-US"` \| `"en-GB"` \| `"bg"` \| `"zh-CN"` \| `"zh-TW"` \| `"hr"` \| `"cs"` \| `"da"` \| `"nl"` \| `"fi"` \| `"fr"` \| `"de"` \| `"el"` \| `"hi"` \| `"hu"` \| `"it"` \| `"ja"` \| `"ko"` \| `"lt"` \| `"no"` \| `"pl"` \| `"pt-BR"` \| `"ro"` \| `"ru"` \| `"es-ES"` \| `"es-419"` \| `"sv-SE"` \| `"th"` \| `"tr"` \| `"uk"` \| `"vi"` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`guildLocale` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`guildLocale` |
| `id` | `public` | `string` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`id` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`id` |
| `locale` | `public` |  \| `"id"` \| `"en-US"` \| `"en-GB"` \| `"bg"` \| `"zh-CN"` \| `"zh-TW"` \| `"hr"` \| `"cs"` \| `"da"` \| `"nl"` \| `"fi"` \| `"fr"` \| `"de"` \| `"el"` \| `"hi"` \| `"hu"` \| `"it"` \| `"ja"` \| `"ko"` \| `"lt"` \| `"no"` \| `"pl"` \| `"pt-BR"` \| `"ro"` \| `"ru"` \| `"es-ES"` \| `"es-419"` \| `"sv-SE"` \| `"th"` \| `"tr"` \| `"uk"` \| `"vi"` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`locale` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`locale` |
| `member` | `public` | `When`\<`FromGuild`, [`InteractionGuildMember`](InteractionGuildMember.md), `undefined`\> | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`member` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`member` |
| `message?` | `public` | [`Message`](Message.md) | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`message` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`message` |
| `replied?` | `public` | `boolean` \| `Promise`\<`boolean`\> | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`replied` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`replied` |
| `token` | `public` | `string` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`token` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`token` |
| `type` | `public` | `User` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`type` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`type` |
| `user` | `public` | [`User`](User.md) | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`user` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`user` |
| `version` | `public` | `1` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`version` | [`ApplicationCommandInteraction`](ApplicationCommandInteraction.md).`version` |

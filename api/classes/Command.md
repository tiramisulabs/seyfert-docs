...
| `__tGroups?` | `Record`\<`string`, \{ `defaultDescription`: `string`; `description`: `undefined` \| `string`; `name`: `undefined` \| `string`; \}\> | `undefined` | - | - |
...
| `groupsAliases?` | `Record`\<`string`, `string`\> | `undefined` | - | - |
...
| `options?` | [`CommandOption`](../type-aliases/CommandOption.md)[] \| [`SubCommand`](SubCommand.md)[] | `undefined` | [`BaseCommand`](BaseCommand.md).`options` | [`BaseCommand`](BaseCommand.md).`options` |
| `props` | [`ExtraProps`](../interfaces/ExtraProps.md) | `{}` | [`BaseCommand`](BaseCommand.md).`props` | [`BaseCommand`](BaseCommand.md).`props` |
| `type` | `ApplicationCommandType` | `ApplicationCommandType.ChatInput` | [`BaseCommand`](BaseCommand.md).`type` | [`BaseCommand`](BaseCommand.md).`type` |
...
[seyfert/src/commands/applications/chat.ts:324](https://github.com/tiramisulabs/seyfert/blob/f061dccf3f80f27124661b050c96d4f946e6387d/src/commands/applications/chat.ts#L324)

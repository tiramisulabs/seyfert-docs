[seyfert](../globals.md) / MediaChannel

# Class: MediaChannel

## Extends

- `ObjectToLower`\<`Omit`\<`APIGuildMediaChannel`, `"type"`\>\>.[`ThreadOnlyMethods`](ThreadOnlyMethods.md).[`BaseChannel`](BaseChannel.md)\<`ChannelType`\>
...
```ts
new MediaChannel(client: UsingClient, data: APIChannelBase<ChannelType>): MediaChannel
```
...
| :------ | :------ | :------ | :------ |
| `availableTags` | `public` | \{ `emojiId`: `null` \| `string`; `emojiName`: `null` \| `string`; `id`: `string`; `moderated`: `boolean`; `name`: `string`; \}[] | `ObjectToLower.availableTags` |
...
| `defaultReactionEmoji` | `public` | `null` \| \{ `emojiId`: `null` \| `string`; `emojiName`: `null` \| `string`; \} | `ObjectToLower.defaultReactionEmoji` |
...
| `permissionOverwrites` | `public` | `undefined` \| \{ `allow`: `string`; `deny`: `string`; `id`: `string`; `type`: `OverwriteType`; \}[] | `ObjectToLower.permissionOverwrites` |
...
| `type` | `public` | `GuildMedia` | [`BaseChannel`](BaseChannel.md).`type` |
...
[`ThreadOnlyMethods`](ThreadOnlyMethods.md).[`setAutoArchiveDuration`](ThreadOnlyMethods.md#setautoarchiveduration)
...
[`ThreadOnlyMethods`](ThreadOnlyMethods.md).[`setReactionEmoji`](ThreadOnlyMethods.md#setreactionemoji)
...
[`ThreadOnlyMethods`](ThreadOnlyMethods.md).[`setSortOrder`](ThreadOnlyMethods.md#setsortorder)
...
[`ThreadOnlyMethods`](ThreadOnlyMethods.md).[`setTags`](ThreadOnlyMethods.md#settags)
...
[`ThreadOnlyMethods`](ThreadOnlyMethods.md).[`setThreadRateLimit`](ThreadOnlyMethods.md#setthreadratelimit)
...
[`ThreadOnlyMethods`](ThreadOnlyMethods.md).[`setTopic`](ThreadOnlyMethods.md#settopic)
...
[`ThreadOnlyMethods`](ThreadOnlyMethods.md).[`thread`](ThreadOnlyMethods.md#thread)

[seyfert](../globals.md) / AnonymousGuild
...
| `client` | `readonly` | [`UsingClient`](../interfaces/UsingClient.md) | `BaseGuild.client` |
...
| `welcomeScreen` | `public` | `undefined` \| \{ `description`: `null` \| `string`; `welcomeChannels`: \{ `channelId`: `string`; `description`: `string`; `emojiId`: `null` \| `string`; `emojiName`: `null` \| `string`; \}[]; \} | `BaseGuild.welcomeScreen` |
